...
<div
	class="flex h-full h-screen w-full flex-col items-center justify-center gap-5 rounded-lg p-5 sm:min-h-full md:flex-col md:justify-center md:border-none md:shadow-none"
>
